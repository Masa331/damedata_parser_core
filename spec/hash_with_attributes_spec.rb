...
RSpec.describe ParserCore::HashWithAttributes do
  describe '#==' do
    it 'returns true if both sides value and attributes are same' do
      with_attrs1 = ParserCore::HashWithAttributes.new({ a: 'hi!' }, {})
      with_attrs2 = ParserCore::HashWithAttributes.new({ a: 'hi!' }, {})
    ...
    it 'returns false if values are different' do
      with_attrs1 = ParserCore::HashWithAttributes.new({ a: 'hi!' }, {})
      with_attrs2 = ParserCore::HashWithAttributes.new({ a: 'bye!' }, {})
    ...
    it 'returns false if attributes are different' do
      with_attrs1 = ParserCore::HashWithAttributes.new({ a: 'hi!' }, {})
      with_attrs2 = ParserCore::HashWithAttributes.new({ a: 'hi!' }, { version: '1' })
