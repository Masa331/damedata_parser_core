...
RSpec.describe ParserCore::StringWithAttributes do
  describe '#==' do
    it 'returns true if both sides value and attributes are same' do
      with_attrs1 = ParserCore::StringWithAttributes.new('hi!', {})
      with_attrs2 = ParserCore::StringWithAttributes.new('hi!', {})
    ...
    it 'returns false if values are different' do
      with_attrs1 = ParserCore::StringWithAttributes.new('hi!', {})
      with_attrs2 = ParserCore::StringWithAttributes.new('bye!', {})
    ...
    it 'returns false if attributes are different' do
      with_attrs1 = ParserCore::StringWithAttributes.new('hi!', {})
      with_attrs2 = ParserCore::StringWithAttributes.new('hi!', { version: '1' })
